...
public class MpMySqlGenerator {
    ...
    // mpg.setTemplateEngine(new FreemarkerTemplateEngine());
        ...
        gc.setOutputDir("E://workspace/generatorUtil/src/main/java");  //生成路径
      ...
      // 自定义文件命名，注意 %s 会自动填充表实体属性！
        ...
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/bbg_inventory?characterEncoding=utf8");
       ...
       /* dsc.setTypeConvert(new MySqlTypeConvert(){
        ...
        strategy.setInclude(new String[] { "tb_inventory" }); // 闇�瑕佺敓鎴愮殑琛�
